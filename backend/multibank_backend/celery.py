...
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'open_banking.settings')

app = Celery('open_banking')
...
app.conf.beat_schedule = {
    ...
    'rotate-audit-logs': {
        ...
        'schedule': crontab(0, 0, day_of_month='1'),  # Первое число каждого месяца
    },
}
