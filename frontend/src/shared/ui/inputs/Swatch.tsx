...
const Swatch = ({value, onChange}: Props) => {
    return <div role="checkbox" onClick={() => onChange(!value)} className={`cursor-pointer w-12 h-5 bg-secondary rounded-full overflow-hidden relative`}>
