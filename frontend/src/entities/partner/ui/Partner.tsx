...
export const Partner = ({partner}: Props) => {
    ...
    return <article className="px-1.5 py-2.5 bg-tertiary rounded-xl flex items-center justify-between">
        ...
        <div className="flex flex-col gap-0.5 items-end">
            ...
            {partner.status === "connected" &&
                <button onClick={() => setModalOpen(true)} className="text-light text-[0.6rem] cursor-pointer">Отключить</button>}
        </div>
